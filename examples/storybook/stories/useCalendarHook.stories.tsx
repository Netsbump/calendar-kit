...
import { useCalendarContext, CalendarProvider } from '@calendar/react-calendar';
import type { CalendarView } from '../../../packages/calendar-core/dist';

// Composant qui contient la logique d'affichage
const UseCalendarDemoContent = () => {
  const {
    view,
    currentDate,
    getDayNames,
